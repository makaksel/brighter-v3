  ...
  return (
    <>
      <Link href={'#form'} className={cn('btn', { isHideBtn })} ref={btnRef}>
        <svg className={cn('btn-icon', [cn('dot')])} width="44" height="30" viewBox="0 0 44 30" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <svg className={cn('btn-icon', [cn('arrow')])} width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
          <rect width="35" height="35" rx="17.5"/>
          <path
            className={cn('arrow-path')}
