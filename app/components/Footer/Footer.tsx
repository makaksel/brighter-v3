...
export const Footer: React.FC<FooterProps> = ({theme = 'dark', className}) => <footer
    ...
    <div className={cn('bottom')}>
      <div className={cn('docs')}>
        <a href='/police.doc' className={cn('bottom-text')} download="Политика конфиденциальности">Политика конфиденциальности</a>
        <a href='/sends.docx' className={cn('bottom-text')} download="Согласие на рассылку">Согласие на рассылку</a>
        <a href='/operations.docx' className={cn('bottom-text')} download="Согласие на обработку ПД">Согласие на обработку ПД</a>
