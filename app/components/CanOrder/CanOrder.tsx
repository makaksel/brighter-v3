...
import './CanOrder.scss';

const cn = makeCn('can-order');

export const CanOrder: React.FC = () => <section className={cn()}>
    ...
    <div className={cn('body')}>
      ...
      <div className={cn('card')}>
        <svg xmlns='http://www.w3.org/2000/svg' className={cn('card-icon')} width='60' height='60' viewBox='0 0 60 60'
          ...
          <ellipse cx='45' cy='12.5' rx='2.5' ry='2.5' fill='#3E51FF' />
          <ellipse cx='35' cy='12.5' rx='2.5' ry='2.5' fill='#3E51FF' />
        </svg>
