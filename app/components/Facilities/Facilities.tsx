    ...
    <div className={cn('left')}>
      ...
      <FacilitiesCard
        ...
        icon={<svg xmlns='http://www.w3.org/2000/svg' className={cn('card-icon')} width='60' height='60'
          ...
          <path d='M35.7187 38.3962H22.2188' stroke='white' strokeWidth='2' strokeLinecap='round'
                strokeLinejoin='round' />
          <path d='M30.6087 29.015H22.2188' stroke='white' strokeWidth='2' strokeLinecap='round'
                strokeLinejoin='round' />
        </svg>}
      />
      <FacilitiesCard
        ...
        icon={<svg xmlns='http://www.w3.org/2000/svg' className={cn('card-icon')} width='60' height='60'
          ...
          <path fillRule='evenodd' clipRule='evenodd'
                ...
                stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
          <path d='M48.0117 21.6727V31.6977' stroke='white' strokeWidth='2' strokeLinecap='round'
                strokeLinejoin='round' />
          <path d='M53.1234 26.6851H42.8984' stroke='white' strokeWidth='2' strokeLinecap='round'
                strokeLinejoin='round' />
        </svg>}
      />
