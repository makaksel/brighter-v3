...
import review3 from '@/src/resources/images/review3.jpg';
import review4 from '@/src/resources/images/review4.jpg';
  ...
  const slides: CardProps[] = [
    {
      ...
      badges: ['Бизнес-центр'],
      rating: 5,
      text: 'Сливал бюджет уже год, думал закрывать бизнес, по рекламе от блогера перешел на сайт и сделал прожарку. Оказывается решение было на поверхности, дизайн для бизнеса реально решает',
    ...
    },
    {
      ...
      badges: ['кафе'],
      rating: 5,
      text: 'Не знаю как вы это сделали, но мой сайт буквально заново собрали по частям. С командой до сих в шоке от кол-ва лидов',
    },
    {
      name: 'Максим',
      img: review3,
      badges: ['книги'],
      rating: 5,
      text: 'Друг для бизнеса уже обращался сюда, делали красиво. Я долго сомневался нужно мне или нет, но решил рискнуть и ни разу не пожалел, что купил подписку',
    },
    {
      name: 'Ольга',
      img: review4,
      badges: ['школа'],
      rating: 5,
      text: 'Долго не могли найти дизайнера в штаб онлайн-школы и тут наткнулись на сайт, купили подписку. Сказать, что мы в восторге — это не сказать ничего. Дизайн нереальный, да и еще все быстро так, огонь!',
